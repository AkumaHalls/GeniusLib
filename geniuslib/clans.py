...
class Clan(BaseClan):
    ...
    member_count: :class:`int`
        The number of members in the clan.
    label_cls: :class:`geniuslib.Label`
        The type which the labels found in :attr:`Clan.labels` will be of.
        Ensure any overriding of this inherits from :class:`geniuslib.Label`.
    member_cls: :class:`geniuslib.ClanMember`
        The type which the members found in :attr:`Clan.members` will be of.
        Ensure any overriding of this inherits from :class:`geniuslib.ClanMember`.
    capital_district_cls: :class:`geniuslib.CapitalDistrict`
        The type which the clan capital districts found in
        :attr:`Clan.capital_districts` will be of. Ensure any overriding of
        this inherits from :class:`geniuslib.CapitalDistrict`.
    war_league: :class:`geniuslib.BaseLeague`
        The clan's CWL league.
    capital_league: :class:`geniuslib.BaseLeague`
    ...
    def get_member_by(self, **attrs) -> typing.Optional[ClanMember]:
        ...
        This search implements the :func:`geniuslib.utils.get` function
        ...
        .. code-block:: python3
            ...
            member = clan.get_member_by(role=geniuslib.Role.elder)
