...
class Client:
    ...
    key_names : str
        ...
        have this name.
        Defaults to "Created with geniuslib Client".
    ...
    load_game_data: :class:`LoadGameData`
        The option for how geniuslib will load game data. See :ref:`initialising_game_data` for more info.
    ...
    realtime: :class:`bool`
        ...
        special flags that will only be interpreted by geniuslib if you set this
        bool to True.
    ...
    raw_attribute: :class:`bool`
        ...
        for later use or are interested in new things that geniuslib does not support otherwise yet. But because this
    ...
    def __init__(
        ...
        *,
        key_count: int = 1,
        key_names: str = "Created with geniuslib Client",
    ...
    async def search_clans(
        ...
        **kwargs,
        ...
        label_ids: :class:`List`[Union[:class:`geniuslib.Label`, :class:`int`]]
    ...
    def get_clan_wars(self, clan_tags: Iterable[str], cls: Type[ClanWar] = None, **kwargs) -> AsyncIterator[ClanWar]:
        ...
        This returns a :class:`geniuslib.WarIterator` which fetches the requested wars in parallel.
    ...
    async def get_current_war(
        ...
        **kwargs
        ...
        cwl_round: :class:`WarRound`
            An enum detailing the type of round to get. Could be ``geniuslib.WarRound.previous_war``,
            ``geniuslib.WarRound.current_war`` or ``geniuslib.WarRound.preparation``.
            This defaults to ``geniuslib.WarRound.current_war``.
