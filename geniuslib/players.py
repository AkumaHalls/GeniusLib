...
class ClanMember(BasePlayer):
    ...
    clan_cls: :class:`geniuslib.Clan`
        The class to use to create the :attr:`ClanMember.clan` attribute.
        Ensure any overriding of this inherits from :class:`geniuslib.Clan` or :class:`geniuslib.PlayerClan`.
    league_cls: :class:`geniuslib.League`
        The class to use to create the :attr:`ClanMember.league` attribute.
        Ensure any overriding of this inherits from :class:`geniuslib.League`.
    builder_base_league_cls: Optional[:class:`geniuslib.League`]
        The class to use to create the :attr:`ClanMember.builder_base_league` attribute.
        Ensure any overriding of this inherits from :class:`geniuslib.BaseLeague`.
    """
