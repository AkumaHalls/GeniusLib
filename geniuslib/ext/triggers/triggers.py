...
class BaseTrigger(ABC):
    ...
    autostart: Optional[:class:`bool`]
        ...
        you can use `geniuslib.ext.triggers.start_triggers()` to manually kick the trigger execution off once you
        have loaded all required resources

    error_handler: Optional[:class:`geniuslib.ext.triggers.CoroFunction`]
...
class IntervalTrigger(BaseTrigger):
    ...
    .. code-block:: python3
        ...
        async def download_current_war(clan_tag: str):
            # use your geniuslib client to fetch war data, store it to a file or database, ...
            pass
    ...
    def __str__(self):
        return f'geniuslib.ext.triggers.IntervalTrigger(seconds={self._interval_seconds})'
...
class CronTrigger(BaseTrigger):
    ...
    Attributes
    ----------
    cron_schedule: Union[:class:`str`, :class:`geniuslib.ext.triggers.CronSchedule`]
    ...
    def __str__(self):
        return f'geniuslib.ext.triggers.CronTrigger(cron_schedule="{self.cron_schedule.cron_str}")'
...
async def start_triggers():
    ...
    .. code-block:: python3
        ...
        if __name__ = '__main__':
            # login to geniuslib.py and/or load other required resources here
