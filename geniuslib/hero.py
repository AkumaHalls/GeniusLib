...
class Hero(LeveledUnit):
    ...
    def asset_url(self) -> str:
        """Caminho relativo do asset de ícone deste herói."""
        from .utils import asset_path
        return asset_path("heroes", self.name)
...
class Pet(LeveledUnit):
    ...
    @property
    def asset_url(self) -> str:
        """Caminho relativo do asset de ícone deste pet."""
        from .utils import asset_path
        return asset_path("pets", self.name)
...
class Equipment(LeveledUnit):
    ...
    @property
    def asset_url(self) -> str:
        """Caminho relativo do asset de ícone deste equipamento."""
        from .utils import asset_path
        return asset_path("equipment", self.name)
